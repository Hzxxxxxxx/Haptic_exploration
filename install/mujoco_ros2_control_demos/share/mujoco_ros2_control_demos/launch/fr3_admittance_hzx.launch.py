...
def generate_launch_description():
    ...
    controller_yaml = os.path.join(pkg_share, 'config', 'fr3_admittance_control.yaml')
    ...
    return LaunchDescription([
        ...
        RegisterEventHandler(OnProcessExit(
            ...
            on_exit=[load_jpc])),
        # 当 position controller 激活完，就接着激活 admittance
        RegisterEventHandler(OnProcessExit(
            target_action=load_jpc,
            on_exit=[load_adm])),
        mujoco_node,
        rsp_node,
    ])
